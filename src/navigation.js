...
export const footerData = {
  ...
  socialLinks: [
    { ariaLabel: 'LinkedIn', icon: 'tabler:brand-linkedin', href: 'https://www.linkedin.com/in/abhinavkakku/' },
    { ariaLabel: 'Instagram', icon: 'tabler:brand-instagram', href: 'https://www.instagram.com/ethicalhackx/' },
    { ariaLabel: 'X', icon: 'tabler:brand-x', href: 'https://x.com/ethicalhackx' },
